          ...
          <div class="col-md-7 col-sm-12">
            <div class="block">
              <div class="section-title">
                ...
                <p>Imagine exploring a location from your computer or phone. A virtual tour is a simulation of a real location made with media, including still photography, 360-degree panoramas, video, text, narration, and more. Virtual tours allow viewers to see a location and experience it without having to actually go there. When viewing a 360 virtual tour, you can interact with the tour by using your computer’s mouse or touchpad to “look around” the location. This gives you a true sense of what it would be like to visit the location.</p><p><a href="pricing.php" class="btn btn-default btn-call-to-action" style="background-color:#660099;color: #ffffff">Ask for Quotation</a></p>
              </div>
            </div>
          </div><!-- .col-md-7 close -->
          <div class="col-md-5 col-sm-12">
            <div class="block">
              <img src="img/360_main.jpg" alt="Img">
            </div>
          </div><!-- .col-md-5 close -->
        </div>
      </div>
        ...
        <div class="row">
            ...
            <div class="block">
              <div class="bs-example">
                  ...
                  <a href="#myModal" data-toggle="modal"><img src="img/14.png"></a>
                  <!-- Modal HTML -->
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <iframe id="cartoonVideo" width="560" height="315" src="https://www.youtube.com/embed/mIRge7H4qYs" frameborder="0" allowfullscreen></iframe>
                              </div>
                          </div>
                      </div>
                  </div>
          ...
          <div class="col-md-7 col-sm-12">
            <div class="block">
              <div class="section-title">
                <h2>360 VIRTUAL TOUR</h2>
                <p>People use virtual tours and 360 virtual tours for many reasons. High school students take virtual tours of college and university campuses. Travelers take virtual tours of hotels and travel destinations. Some people even take virtual tours of corporate offices when considering applying for a job to experience their corporate culture and campus.</p>
              </div>
            </div>
          </div><!-- .col-md-7 close -->
        <!-- .col-md-5 close -->
        ...
        <div class="row">
          <div class="col-md-7 col-sm-12">
            <div class="block">
              <div class="section-title">
                <h2>360 SITE VIEW</h2>
                <p>A 360 Arial view of the site so anyone can visit it’s surrounding on web, phone or tablet It can be use in real estate, hospitality industry, resorts, hotels etc. So, you don't need to assume anything where you are located or how it going to look like you can see everything from your mobile itself. Even you can share it and anyone can visit it from anywhere at anytime.</p>
              </div>
            </div>
          </div><!-- .col-md-7 close -->
          <div class="col-md-5 col-sm-12">
            <div class="block">
              <div class="bs-example">
                  <!-- Button HTML (to Trigger Modal) -->
                  <a href="#myModal1"  data-toggle="modal"><img src="img/15.png"></a>
                  <!-- Modal HTML -->
                  <div id="myModal1" class="modal fade">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <iframe id="cartoonVideo1" width="560" height="315" src="https://www.youtube.com/embed/LAMQY8Q0-aE" frameborder="0" allowfullscreen></iframe>
                              </div>
                          </div>
                      </div>
                  </div>
